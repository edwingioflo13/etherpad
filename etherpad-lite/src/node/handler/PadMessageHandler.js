...
exports.handleDisconnect = function(client)
{
  ...
  if(session && session.author)
  {
    ...
    cliente.post("https://devops.espe.edu.ec:8080/loadBalancer/leave", args, function (data, response) {
    });
  ...
  async.series([
    ...
    function(callback)
    {
      ...
      if(pad.head > 0) {
        ...
        cliente.post("https://devops.espe.edu.ec:8080/loadBalancer/create", args, function (data, response) {
        });
      }
      else if(pad.head == 0) {
